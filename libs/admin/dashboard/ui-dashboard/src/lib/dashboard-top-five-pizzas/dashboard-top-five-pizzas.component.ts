...
import { ChartBlue, chartConfig, ChartGreen } from '@nnpz/admin/util-theme';
import { ChartDataset } from 'chart.js';

@Component({
  selector: 'admin-ui-dashboard-top-five-pizzas',
  templateUrl: './dashboard-top-five-pizzas.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AdminUiDashboardTopFivePizzasComponent {
